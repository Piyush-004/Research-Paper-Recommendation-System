...
# Load your data (uncomment these in your actual application)
embeddings = pickle.load(open('C:\\Users\\hrish\\PycharmProjects\\rprs\\.venv\\embeddings.pkl', 'rb'))
sentences = pickle.load(open('C:\\Users\\hrish\\PycharmProjects\\rprs\\.venv\\sentences.pkl', 'rb'))
rec_model = pickle.load(open('C:\\Users\\hrish\\PycharmProjects\\rprs\\.venv\\rec_model.pkl', 'rb'))
...
st.set_page_config(page_title="MyResearchPal", page_icon="📚", layout="wide")
...
st.markdown("""
    <div class="footer">
        Made by MyResearchPal Team | <a href="mailto:support@myresearchpal.com">Contact Us</a> | <a href="/privacy-policy">Privacy Policy</a>
    </div>
    """, unsafe_allow_html=True)
